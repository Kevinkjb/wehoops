    ...
    <div>
      <div className="registration-form">
            ...
            <select className='selected-items' id="program" name="Program">
                ...
                <option value="3x3 Open Division">3x3 Open Division</option>
                <option value="3x3 Master Division">3x3 Master Division</option>
                <option value="Baskeball League Open Division">Baskeball League Open Division</option>
                <option value="Baskeball League Master Division">Baskeball League Master Division</option>
            </select>
            </div>
